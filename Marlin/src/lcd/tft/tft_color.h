...
#define COLOR_DARK_PURPLE     0x9930  // #992380
  ...
  #define COLOR_SELECTION_BG    COLOR_TEAL    // #992380
#endif
#ifndef COLOR_WEBSITE_URL
  #define COLOR_WEBSITE_URL     COLOR_AQUA
#endif
  ...
  #define COLOR_AXIS_NOT_HOMED    COLOR_BLUE
#endif
  ...
  #define COLOR_PRINT_TIME        COLOR_LIGHT_BLUE
#endif
  ...
  #define COLOR_PROGRESS_BAR      COLOR_LIME
#endif
  ...
  #define COLOR_MENU_VALUE        COLOR_GREY
#endif

#ifndef COLOR_SLIDER
  #define COLOR_SLIDER            COLOR_TEAL  
#endif
